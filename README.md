...
|US55|Gestión de Tratamientos|Como desarrollador, necesito implementar el endpoint de tratamientos, para permitir que los usuarios gestionen sus tratamientos médicos.|<p>Escenario 1: Agregar un nuevo tratamiento</p><p>Dado que un usuario desea agregar un nuevo tratamiento a su historial médico,</p><p>Cuando envía una solicitud POST con la
