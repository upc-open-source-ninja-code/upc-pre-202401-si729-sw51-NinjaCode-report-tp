...
|**US16**|Usuario se registra como paciente con código proporcionado por médico.|Como paciente quiero registrarme usando un código proporcionado por mi médico para que él pueda gestionar mi tratamiento de manera remota.|<p>**Escenario 1:** Usuario desea registrarse como paciente.</p><p>**Dado que** un usuario desea registrarse en HormonalCare como paciente.</p><p>**Cuando** se encuentre en la pantalla de bienvenida y haga clic en la opción "Registrarse".</p><p>**Entonces** se abrirá el formulario donde podrá ingresar sus datos personales.</p><p>**Escenario 2:** Usuario ingresa código de médico al registrarse como paciente.</p><p>**Dado que** un usuario está en el proceso de registro y tiene un código de médico.</p><p>**Cuando** selecciona "Sí" en respuesta a la pregunta "¿Viene de parte de algún médico?".</p><p>**Entonces** se habilita el campo para ingresar el código del médico.</p><p>**Y** el sistema valida si el código existe en la base de datos, configurando la pantalla principal del paciente según su médico.</p>|Epic010|
|**US17**|Cambiar plan de suscripción como médico desde el perfil de usuario.|Como médico quiero poder cambiar mi plan de suscripción para atender a más pacientes.|<p>**Escenario 1:** Médico encuentra la opción para cambiar su plan de suscripción.</p><p>**Dado que** el médico se encuentra en su pantalla principal.</p><p>**Cuando** hace clic en el botón "Perfil" en el menú.</p><p>**Entonces** se carga su perfil de usuario donde aparece el contador de pacientes permitidos por su plan y el botón "Mejorar plan".</p><p>**Escenario 2:** Médico realiza cambio de plan de suscripción.</p><p>**Dado que** el médico está en su perfil de usuario.</p><p>**Cuando** selecciona "Mejorar plan".</p><p>**Entonces** se abre una ventana con información sobre su plan actual y las opciones disponibles para actualizarlo.</p><p>**Escenario 3:** Médico cancela su suscripción.</p><p>**Dado que** el médico está en la ventana de cambio de plan en su perfil.</p><p>**Cuando** hace clic en "Cancelar suscripción".</p><p>**Entonces** se le pregunta si desea confirmar la cancelación.</p><p>**Y** si confirma, se muestra un mensaje de despedida; si no, vuelve al proceso de cambio de suscripción.</p>|Epic001|
|**US18**|Médico asigna paciente y programa cita con colega.|Como médico quiero poder transferir pacientes a otros médicos para gestionar mejor mis horarios.|<p>**Escenario 1:** Médico busca a su colega para asignarle un paciente.</p><p>**Dado que** el médico necesita asignar un paciente a un colega.</p><p>**Cuando** utiliza la función de búsqueda e ingresa el correo del colega.</p><p>**Entonces** se muestra el perfil del colega con su información y certificaciones.</p><p>**Escenario 2:** Médico contacta con colega para transferir paciente.</p><p>**Dado que** el médico está viendo el perfil de su colega.</p><p>**Cuando** hace clic en "Enviar mensaje".</p><p>**Entonces** se abre un chat donde puede informar sobre la transferencia del paciente.</p><p>**Escenario 3:** Transferencia de paciente a colega.</p><p>**Dado que** el médico ha contactado con su colega y acordado la transferencia de un paciente.</p><p>**Cuando** está en el perfil del colega y selecciona "Asignar paciente".</p><p>**Entonces** se muestran los pacientes del médico y puede asignar uno al colega, configurando un horario sin necesidad de pago previo.</p>|Epic003|
|**US19**|Ver información detallada de los pacientes como médico.|Como médico deseo tener acceso organizado a la información detallada de mis pacientes para llevar un seguimiento efectivo de su tratamiento.|<p>**Escenario 1:** Ver información resumida de los pacientes.</p><p>**Dado que** el médico quiere revisar la información resumida de sus pacientes.</p><p>**Cuando** ha iniciado sesión en la plataforma.</p><p>**Entonces** se muestra en la pantalla principal toda la información de la lista de pacientes según su plan de suscripción.</p><p>**Escenario 2:** Ver detalle de información de un paciente.</p><p>**Dado que** el médico necesita acceder a la información detallada de un paciente específico.</p><p>**Cuando** hace clic en el nombre de un paciente desde la lista principal.</p><p>**Entonces** se muestra toda la información disponible del paciente seleccionado.</p>|Epic008|
|**US20**|Ver lista de pacientes programados para el día como médico.|Como médico deseo visualizar la lista de pacientes programados para el día para organizar eficientemente mis citas médicas.|<p>**Escenario 1:** Médico revisa los pacientes del día.</p><p>**Dado que** el médico necesita organizar su agenda diaria.</p><p>**Cuando** accede a su sección principal.</p><p>**Entonces** se muestra una lista clara de todos los pacientes programados para ese día, con información relevante como nombre, tipo de atención, hora y detalles adicionales.</p><p>**Escenario 2:** Médico busca un paciente específico.</p><p>**Dado que** el médico está en su sección principal.</p><p>**Cuando** utiliza la herramienta de búsqueda de pacientes.</p><p>**Entonces** puede encontrar rápidamente cualquier paciente dentro de su lista.</p>|Epic008|
...
| Datos del médico: | Entrevista |
|---|---|
|<img src="images/EntrevistaValidacionLuisChinchihualpa.png" width=400>|  |
...
| Datos del médico: | Entrevista |
|---|---|
| <img src="images/EntrevistaValidacionErnestoRequejo.png" width=300 height= 200> | |
...
| Datos del paciente: | Entrevista |
|---|---|
| <img src="images/paciente1-vali.png" width=400> | |
...
| Datos del paciente: | Entrevista |
|---|---|
| <img src="images/EntrevistaValidacionSebastianLobato.png" width=400> | |
...
<img src="images/heuristicaDoctor2.png" width=400>
...
<img src="images/heuristicaDoctor3.png" width=400>
...
<img src="images/heuristicaDoctor4.png" width=400>
