...
|      |                                                                                                           | T03: Pruebas de la interfaz de selección de Rol     | Realizar pruebas para asegurar que la selección de rol funcione correctamente y que los usuarios puedan acceder a las funciones adecuadas según su rol. | 2                  | Luis        |                     |
| US10 | Registro de usuario                                                                                      | T01: Diseño del formulario de Registro de Usuario    | Crear un diseño para el formulario que permita a los usuarios registrarse en la aplicación.                                          | 3                  | Estéfano    |                     |
|      |                                                                                                           | T02: Implementación del formulario de Registro de Usuario | Codificar el formulario de registro basado en el diseño, con validaciones y funcionalidad de creación de cuenta.                      | 5                  | Sebastian   |                     |
...
|      |                                                                                                           | T02: Pruebas de la funcionalidad de historial médico  | Realizar pruebas para asegurar que los médicos puedan acceder y visualizar correctamente el historial médico de sus pacientes.       | 3                  | Luis        |                     |
